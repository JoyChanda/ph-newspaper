        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-bold">PH Newspaper</h3>
            </div>
            <p className="text-gray-400 mb-4">
              বাংলাদেশের সর্বশেষ ও বিশ্বস্ত সংবাদের উৎস। আমরা সত্য ও নিরপেক্ষ সংবাদ পরিবেশনে প্রতিশ্রুতিবদ্ধ।
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-white">দ্রুত লিংক</h3>
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/about" className="text-gray-400 hover:text-white transition-colors flex items-center gap-2">
                  <span className="text-red-500">▸</span> আমাদের সম্পর্কে
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-gray-400 hover:text-white transition-colors flex items-center gap-2">
                  <span className="text-red-500">▸</span> যোগাযোগ
                </Link>
              </li>
              <li>
                <Link href="/privacy" className="text-gray-400 hover:text-white transition-colors flex items-center gap-2">
                  <span className="text-red-500">▸</span> গোপনীয়তা নীতি
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-gray-400 hover:text-white transition-colors flex items-center gap-2">
                  <span className="text-red-500">▸</span> শর্তাবলী
                </Link>
              </li>
            </ul>
          </div>
          ...
          {/* Categories */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-white">বিভাগসমূহ</h3>
            <ul className="space-y-2">
          ...
          {/* Newsletter */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-white">নিউজলেটার</h3>
            ...
            <form className="space-y-3">
              <input
                ...
                className="w-full px-4 py-2.5 rounded-lg bg-gray-700 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500"
              />
              <button
                type="submit"
                className="w-full px-4 py-2.5 bg-gradient-to-r from-red-600 to-blue-600 text-white font-bold rounded-lg hover:shadow-lg transition-all hover:scale-105"
              >
                সাবস্ক্রাইব করুন
              </button>
            </form>
        ...
        <div className="border-t border-gray-700 pt-6 mt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-gray-400 text-sm text-center md:text-left">
              © ২০২৬ PH Newspaper. সর্বস্বত্ব সংরক্ষিত।
            </p>
